...
import { ApiStatus, ICheque, IChequeForm, IPositions, IUpdateChequeActionProps } from '../../modules/Cheques/Cheque.type';
import { createChequeAction, updateChequeAction } from '../../modules/Cheques/ChequeSlice';
...
const Modal = (props: IProps) => {
  ...
  const { onClose, user, cheque, onRerenderClick } = props;
  ...
  const { createChequeFormStatus, updateChequeFormStatus } = useAppSelector((state: RootState) => state.cheque)
